...
/*								     */
/* modifications					             */
/* 01/23/21     JS  Added in Edge Detection and Sharpening Filter    */
	...
	while(back2menu == 1){
		...
		switch(choice){
			...
			case 4: /* Run Edge Detection Filter */
				EdgeDetection(R, G, B);
				printf("Edge Detection operation done!\n");
				break;
...
{   
	...
	/* Setting the edge pixels without full pixels surrounding to black color */
